  ...
  return (
    <div className="navigation mt-2">
      ...
      <div className="nav-links-container " >
        ...
        {
          showSignout ? <div className="d-flex align-items-end w-50 justify-content-around"> <Link onClick={handleLogout} className="p-0 me-2 ms-2 nav-link">SIGN OUT</Link>        <Link className="nav-link ms-1" to={"/settings"}>
